 ...
 */
package org.jboss.arquillian.container.spring.embedded_3.shrinkwrap;
...
public class StrictShrinkWrapClassLoader extends URLClassLoader implements Closeable
{
   ...
   private final List<String> waivedPackages;
    ...
    */
   public StrictShrinkWrapClassLoader(final List<String> waivedPackages, final Archive<?>... archives)
   {
      super(new URL[] {});
      ...
      this.waivedPackages = new ArrayList<String>(waivedPackages);
    ...
    * @param archives the {@link Archive}s from which to load classes and resources
    */
   public StrictShrinkWrapClassLoader(final ClassLoader parent, final List<String> waivedPackages, final Archive<?>... archives)
   {
   ...
   {
      StringTokenizer tok = new StringTokenizer(name.substring(0, name.lastIndexOf('.')), ".");
      String pkg = null;
      while (tok.hasMoreTokens())
      {
         ...
         if (waivedPackages.contains(pkg))
         {
